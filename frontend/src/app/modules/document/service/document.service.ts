...
import {ApiResponse, ApiUriEnum, AppUriEnum, MenuActionType} from "@shared/model";
...
export class DocumentService extends ApiService {
  ...
  public update(payload: DocumentUpdatePayload): Observable<ApiResponse> {
    return this.put(ApiUriEnum.DOCUMENT_UPDATE, payload);
  }
  ...
  public delete(id: string): Observable<ApiResponse> {
    return this.delete(`${ApiUriEnum.DOCUMENT_DELETE}/${id}`);
  }

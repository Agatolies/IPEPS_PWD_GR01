    ...
    switch (currentAction) {
      case MenuActionType.LIST:
        actions = [{
          ...
          link: AppRouteEnum.CONTACT_SHOW_HOME_PAGE,
        }]
        break;
      case MenuActionType.ADD:
        actions = [{
            ...
            link: AppRouteEnum.CONTACT_CREATE,
          }]
        break;
      case MenuActionType.UPDATE:
        actions = [{
          ...
          link: AppRouteEnum.CONTACT_UPDATE,
        }]
        break;
      case MenuActionType.DETAIL:
        actions = [{
          ...
          link: AppRouteEnum.CONTACT_DETAIL,
        }]
        break;
      case MenuActionType.DELETE:
        actions = [{
          ...
          link: AppRouteEnum.CONTACT_DELETE,
        },
          {

...
export class OrganizationService extends ApiService {
  ...
  public getListOfOrganizationForDropdown(): Observable<OrganizationDto[]> {
    return this.get(ApiUriEnum.ORGANIZATION_LIST)
      .pipe(map(response => response.data as OrganizationDto[])
      )
  }
